...
| 7 | *(опционально)* Заявка на КП с главной | `#lead-form` |
...
| Обязательно тянуть **все** CMS-таблицы в UI | Таблицы уже в БД (TASK-009), но для диплома достаточно статики в PHP; *опционально* FAQ/hero из `site_settings` — 1 запрос, без отдельных страниц |
...
| Поле | Значение |
|------|----------|
| **Последняя задача** | ROADMAP TASK-009 (миграции + seed) |
| **Следующая** | **OPT-010** (пакет O2-Shell) |
...
- [ ] **Зависимости:** OPT-020..024, OPT-044 (форма — можно заглушку, потом O5)
