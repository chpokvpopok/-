...
return [
    ...
    'database' => [
        ...
        // XAMPP по умолчанию: root без пароля. В Docker/production задайте DB_USER / DB_PASSWORD.
    ...
    'session' => [
        ...
        // На http://localhost cookie с Secure не применится — для XAMPP по умолчанию false.
