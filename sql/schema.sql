...
-- Опции для товара id=2 (ETEO-M3)
INSERT INTO product_options
    (product_id, option_name_ru, option_name_kk, option_type,
     option_value_ru, option_value_kk, option_group, price_modifier, sort_order)
VALUES
-- Группа: Материал столешницы (select)
(2, 'Материал столешницы', 'Үстел материалы', 'select',
 'ЛДСП стандарт', 'ЛДСП стандарт', 'material', 0.00, 1),
(2, 'Материал столешницы', 'Үстел материалы', 'select',
 'HPL-пластик', 'HPL-пластик', 'material', 55000.00, 2),
(2, 'Материал столешницы', 'Үстел материалы', 'select',
 'Натуральный шпон', 'Натурал шпон', 'material', 110000.00, 3),

-- Группа: Модульная конфигурация (select)
(2, 'Количество рабочих мест', 'Жұмыс орындарының саны', 'select',
 '3 места', '3 орын', 'config', 0.00, 4),
(2, 'Количество рабочих мест', 'Жұмыс орындарының саны', 'select',
 '4 места', '4 орын', 'config', 180000.00, 5),
(2, 'Количество рабочих мест', 'Жұмыс орындарының саны', 'select',
 '6 мест', '6 орын', 'config', 350000.00, 6),

-- Дополнительные опции (checkbox)
(2, 'Блок розеток и USB', 'Розетка және USB блогы',
 'checkbox', NULL, NULL, 'extras', 22000.00, 7),
(2, 'Система климат-контроля', 'Климат бақылау жүйесі',
 'checkbox', NULL, NULL, 'extras', 85000.00, 8),
(2, 'Кронштейны для мониторов (6 шт.)', 'Монитор кронштейндері (6 дана)',
 'checkbox', NULL, NULL, 'extras', 54000.00, 9),
(2, 'LED-подсветка рабочей зоны', 'Жұмыс аймағының LED-жарықтандыруы',
 'checkbox', NULL, NULL, 'extras', 28000.00, 10),
(2, 'Модуль кабель-менеджмента', 'Кабель менеджмент модулі',
 'checkbox', NULL, NULL, 'extras', 35000.00, 11);
